namespace ABeko.Tests.Handlers
{
    using System;
    ...
    public class KernelMemoryHandler : IMemoryHandler
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KernelMemoryHandler"/> class.
        /// </summary>
        public KernelMemoryHandler()
        {
            // KernelMemoryHandler
        }
